  ...
  return (
    <div>
      ...
      <IconArray
        ...
        ariaLabel="Example icon array. 30 to 50 out of 100 circles are red; the rest are gray." />
...
function App({ content }) {
  ...
  let body = null;
  if (current === 'welcome') body = <ModuleWelcome content={content} />;else
  if (current === 'howto') body = <ModuleHowToRead content={content} />;else
  if (current === 'risk') body = <ModuleCancerRisk content={content} />;else
  if (current === 'options') body = <ModuleOptionsOverview content={content} onGo={() => setCurrent('compare')} />;else
  if (current === 'compare') body = <ModuleComparison content={contentForRender} discussFlags={discussFlags} setDiscussFlag={setDiscussFlag} />;else
  if (current === 'values') body = <ModuleValues content={content} valuesState={valuesState} setValuesState={setValuesState} />;else
  if (current === 'questions') body = <ModuleQuestions content={content} checkedQs={checkedQs} setCheckedQs={setCheckedQs} priorityQs={priorityQs} setPriorityQs={setPriorityQs} customQs={customQs} setCustomQs={setCustomQs} />;else
  if (current === 'resources') body = <ModuleResources content={content} onPrint={doPrint} discussFlags={discussFlags} />;
